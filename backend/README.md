...
## Project Structure
    ...
    ├── testapiautostoryboa_73720  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_73720`
...
2. Clone this repo and `cd testapiautostoryboa_73720`
